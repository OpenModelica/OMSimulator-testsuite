...
oms3_addTLMBus("model.tlm3d.wc1.P",oms_tlm_domain_mechanical,3);
...
oms3_addTLMBus("model.tlm3d.wc2.P",oms_tlm_domain_mechanical,3);
...
oms3_setTLMSocketData("model.tlm3d","127.0.1.1",13511,13611)
...
for _,var in ipairs(vars) do
  if 1 == oms3_compareSimulationResults("tlm3d_all.csv", "../ReferenceFiles/tlm3d_all.csv", var, 1e-2, 1e-4) then
    print(var .. " is equal")
  else
