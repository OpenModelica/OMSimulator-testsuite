...
oms3_addTLMBus("model.tlmsignals.wc1.out",oms_tlm_domain_output,1);
oms3_addTLMBus("model.tlmsignals.wc1.in",oms_tlm_domain_input,1);
...
oms3_addTLMBus("model.tlmsignals.wc2.out",oms_tlm_domain_output,1);
oms3_addTLMBus("model.tlmsignals.wc2.in",oms_tlm_domain_input,1);
