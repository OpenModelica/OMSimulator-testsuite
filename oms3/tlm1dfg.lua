...
oms3_newModel("model");
oms3_setResultFile("model","tlm1dfg_res.mat")
...
oms3_addTLMBus("model.tlm1dfg.wc1.fmu.P",oms_tlm_domain_mechanical,1,finegrained);
...
oms3_addTLMBus("model.tlm1dfg.wc2.fmu.P",oms_tlm_domain_mechanical,1,finegrained);
