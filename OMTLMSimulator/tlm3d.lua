...
oms_addSubModel("model.tlm3d.wc1.pendulum", "../FMUs/UpperPendulum.fmu");
...
oms_addSubModel("model.tlm3d.wc2.pendulum", "../FMUs/LowerPendulum.fmu");
...
for _,var in ipairs(vars) do
  if 1 == oms_compareSimulationResults("tlm3d_all.csv", "../ReferenceFiles/tlm3d_all.csv", var, 1e-2, 1e-4) then
    print(var .. " is equal")
  else
