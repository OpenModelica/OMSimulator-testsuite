...
oms_addSubModel("model.tlm1d.wc1.mass", "../FMUs/Mass.fmu");
...
oms_addSubModel("model.tlm1d.wc2.mass", "../FMUs/MassSpring.fmu");
...
for _,var in ipairs(vars) do
  if 1 == oms_compareSimulationResults("tlm1d.csv", "../ReferenceFiles/tlm1d.csv", var, 1e-2, 1e-4) then
    print(var .. " is equal")
  else
