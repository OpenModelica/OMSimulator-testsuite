...
-- adder
oms_addExternalModel("model.tlmexternal.adder", "../FMUs/adder.fmu", "./StartTLMFmiWrapper")
...
-- source1
oms_addExternalModel("model.tlmexternal.source1", "../FMUs/source.fmu", "./StartTLMFmiWrapper")
oms_addTLMBus("model.tlmexternal.source1.y", oms_tlm_domain_output, 1, default)

-- source2
oms_addExternalModel("model.tlmexternal.source2", "../FMUs/source.fmu", "./StartTLMFmiWrapper")
oms_addTLMBus("model.tlmexternal.source2.y", oms_tlm_domain_output, 1, default)

-- gain
oms_addExternalModel("model.tlmexternal.gain", "../FMUs/gain.fmu", "./StartTLMFmiWrapper")
...
oms_terminate("model");
 ...
 for _,var in ipairs(vars) do
   if 1 == oms_compareSimulationResults("tlmexternal.csv", "../ReferenceFiles/tlmexternal.csv", var, 1e-2, 1e-4) then
     print(var .. " is equal")
   else
