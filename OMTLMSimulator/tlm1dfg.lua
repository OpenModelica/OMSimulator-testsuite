...
oms_addSubModel("model.tlm1dfg.wc1.fmu", "../FMUs/TLM_FineGrained1_1D.fmu");
...
oms_addSubModel("model.tlm1dfg.wc2.fmu", "../FMUs/TLM_FineGrained2_1D.fmu");
...
for _,var in ipairs(vars) do
  if 1 == oms_compareSimulationResults("tlm1dfg.csv", "../ReferenceFiles/tlm1dfg.csv", var, 1e-2, 1e-4) then
    print(var .. " is equal")
  else
