...
oms_addSubModel("model.tlmsignals.wc1.adder", "../FMUs/Modelica.Blocks.Math.Add.fmu");
oms_addSubModel("model.tlmsignals.wc1.sine1", "../FMUs/sine.fmu");
oms_addSubModel("model.tlmsignals.wc1.sine2", "../FMUs/sine.fmu");
oms_addSubModel("model.tlmsignals.wc1.gain", "../FMUs/Modelica.Blocks.Math.Gain.fmu");
...
oms_addSubModel("model.tlmsignals.wc2.gain", "../FMUs/Modelica.Blocks.Math.Gain.fmu");
...
oms_setReal("model.tlmsignals.wc1.sine1.A",1);
oms_setReal("model.tlmsignals.wc1.sine1.omega",8);
oms_setReal("model.tlmsignals.wc1.sine2.A",0.3);
oms_setReal("model.tlmsignals.wc1.sine2.omega",20);
...
for _,var in ipairs(vars) do
  if 1 == oms_compareSimulationResults("tlmsignals.csv", "../ReferenceFiles/tlmsignals.csv", var, 1e-2, 1e-4) then
    print(var .. " is equal")
  else
