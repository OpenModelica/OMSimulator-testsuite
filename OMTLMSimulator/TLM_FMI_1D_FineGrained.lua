-- status: correct
-- teardown_command: rm -rf TLM_FMI_1D_FineGrained.log TLM_FMI_1D_FineGrained_tmp/ tlm1d_fg.csv tlm1d_fg.run tlm1d_fg_res.mat TLMlogfile.log
-- linux: yes
-- mingw: no
-- mac: no
...
for _,var in ipairs(vars) do
  if 1 == compareSimulationResults("tlm1d_fg.csv", "../ReferenceFiles/TLM_FMI_1D_FineGrained.csv", var, 1e-2, 1e-4) then
    print(var .. " is equal")
  else
