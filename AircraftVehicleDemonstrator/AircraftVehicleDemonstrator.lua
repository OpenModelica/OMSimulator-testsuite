...
-- instantiate FMUs
oms_addSubModel("AircraftVehicleDemonstrator.root.atmosphere_Model_FMU_sf", "FMUs/Atmosphere_Model_FMU_sf.fmu")
oms_addSubModel("AircraftVehicleDemonstrator.root.bC", "FMUs/bC.fmu")
oms_addSubModel("AircraftVehicleDemonstrator.root.cockpit", "FMUs/cockpit.fmu")
oms_addSubModel("AircraftVehicleDemonstrator.root.consumer_A", "FMUs/consumer_A.fmu")
oms_addSubModel("AircraftVehicleDemonstrator.root.consumer_B", "FMUs/consumer_B.fmu")
oms_addSubModel("AircraftVehicleDemonstrator.root.eCS_Generic_Export", "FMUs/eCS_Generic_Export.fmu")
oms_addSubModel("AircraftVehicleDemonstrator.root.eCS_SW", "FMUs/eCS_SW.fmu")
oms_addSubModel("AircraftVehicleDemonstrator.root.engine", "FMUs/engine.fmu")
...
for _,var in ipairs(vars) do
  if 1 == oms_compareSimulationResults("AircraftVehicleDemonstrator_res.mat", "../ReferenceFiles/AircraftVehicleDemonstrator.mat", var, 1e-2, 1e-4) then
