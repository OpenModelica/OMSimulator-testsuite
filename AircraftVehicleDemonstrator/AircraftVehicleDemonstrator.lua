...
oms2_addConnection("AircraftVehicleDemonstrator", "atmosphere_Model_FMU_sf", "solver")
oms2_addConnection("AircraftVehicleDemonstrator", "bC", "solver")
oms2_addConnection("AircraftVehicleDemonstrator", "cockpit", "solver")
oms2_addConnection("AircraftVehicleDemonstrator", "consumer_A", "solver")
oms2_addConnection("AircraftVehicleDemonstrator", "consumer_B", "solver")
oms2_addConnection("AircraftVehicleDemonstrator", "eCS_Generic_Export", "solver")
oms2_addConnection("AircraftVehicleDemonstrator", "eCS_SW", "solver")
oms2_addConnection("AircraftVehicleDemonstrator", "engine", "solver")
