...
-- instantiate FMUs
oms_addSubModel("DualMassOscillator.root.system1", "../FMUs/DualMassOscillator.System1.fmu")
oms_addSubModel("DualMassOscillator.root.system2", "../FMUs/DualMassOscillator.System2.fmu")
